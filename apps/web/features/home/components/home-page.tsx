              ...
              <CardPanel className="space-y-3">
                {reviewError ? (
                  <Alert variant="error">
                    ...
                    <AlertDescription>{(reviewError as Error).message}</AlertDescription>
                  </Alert>
                ) : null}
                ...
                {!reviewLoading && (reviewItems?.length ?? 0) === 0 ? (
                  <Empty className="min-h-0 px-0 py-8">
                    <EmptyHeader>
                      ...
                      <EmptyDescription>
                        Your review queue is clear. Continue a document or pick something from the recommendations.
                      </EmptyDescription>
                    </EmptyHeader>
                  </Empty>
                ) : null}
                ...
                (recommendations?.suggestedTopics.length ?? 0) === 0 ? (
                  <Empty className="min-h-0 px-0 py-8">
                    <EmptyHeader>
                      ...
                      <EmptyDescription>
                        Add a few more documents and tags to unlock better next-step suggestions.
                      </EmptyDescription>
                    </EmptyHeader>
                  </Empty>
                ) : null}
                        ...
                        <div className="flex min-w-0 items-center gap-3">
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="truncate text-xs text-muted-foreground">
                              {document.tags.slice(0, 3).join(' • ') || 'Recommended next'}
                            </p>
                          </div>
                        </div>
                ...
                {!chatsLoading && recentChats.length === 0 ? (
                  <Empty className="min-h-0 px-0 py-8">
                    <EmptyHeader>
                      ...
                      <EmptyDescription>
                        Ask a question and your recent conversations will appear here.
                      </EmptyDescription>
                    </EmptyHeader>
                  </Empty>
                ) : null}
