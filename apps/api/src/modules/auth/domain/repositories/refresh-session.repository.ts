...
export abstract class IRefreshSessionRepository {
  abstract create(input: CreateRefreshSessionInput): Promise<RefreshSessionEntity>;
  abstract findActiveBySessionId(sessionId: string): Promise<RefreshSessionEntity | null>;
